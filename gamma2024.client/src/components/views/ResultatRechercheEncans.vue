        ...
        encansFiltres.value = encansFiltres.value.filter((encan) => {
            if (stringquery.stringNumeroEncan) {
                if (stringquery.selectNumeroEncan == 0) {
                    if (encan.numeroEncan.valueOf() == stringquery.stringNumeroEncan) {
                        return true
                    }
                    return false
                }
                if (stringquery.selectNumeroEncan == 1 && stringquery.stringNumeroEncan2) {
                    if (encan.numeroEncan.valueOf() >= stringquery.stringNumeroEncan && encan.numeroEncan.valueOf() <= stringquery.stringNumeroEncan2) {
                        return true
                    }
                    return false
                }
