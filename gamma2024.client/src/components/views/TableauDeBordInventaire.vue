      ...
      <div class="dropdown d-flex-1">
        ...
        <ul class="dropdown-menu">
          <li class="d-flex justify-content-start dropdown-item">
            <input
              class="toggle-vis checkboxTous d-flex-1"
              type="checkbox"
              id="tousSelectionnerCheckbox"
            />
            <label
              class="form-check-label d-flex-1"
          ...
          <li class="d-flex justify-content-start dropdown-item">
            <input
              class="toggle-vis checkboxSeul d-flex-1"
              type="checkbox"
              id="lotEncanCheckbox"
              checked
            />
...
let data = ref([
  ...
  [
    ...
    "Normand Hudon",
    "12po x 16po",
    "1990/Le père, le fils et le saint esprit. Amen",
    "Huile sur panneau",
    "Oui",
    "Modifier",
    "Supprimer",
  ...
  [
    ...
    "23po x 28po",
    "19781/Les oies 1",
    "Lithographie (signé dans la plaque)",
    "Oui",
    "Modifier",
    "Supprimer",
  ],
...
onMounted(() => {
  ...
  const listeDesTetesDeColonnes = document.querySelectorAll("th");
  ...
  //querySelector("label[for='login']")

  //function AfficheLesImagesDansLeTableau() {
  //    document.querySelectorAll("th").forEach((el) => {
  //        el.classList.remove("dt-orderable-asc");
  //        el.classList.remove("dt-orderable-desc");
  //        el.classList.remove("dt-ordering-asc");
  //    });
  //};
});
</script>
