                ...
                <div class="container-fluid justify-content-center justify-content-md-between d-flex flex-row-reverse">
                    <form class="d-flex align-items-center">
                        <div class="d-flex input-group mt-1" v-if="activationRecherche">
                            <button class="btn btn-outline bleuMoyenFond text-white butttonNavBar py-0 btnSurvolerBleuMoyenFond dropdown-toggle" data-bs-toggle="dropdown">
                                Recherche Avancée
                            </button>
                            <ul class="dropdown-menu">
                                ...
                                <li v-for="(visible, colonne) in colonnesDeCriteres"
                                    :key="colonne"
