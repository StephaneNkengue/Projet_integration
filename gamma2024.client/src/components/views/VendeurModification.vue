                ...
                <div class="card-body p-md-3 text-black">
                  ...
                  <form @submit.prevent="submitForm">
                    <div class="row">
                      <div class="col-md-6 mb-4">
                        <div class="form-outline">
                          <input v-model="vendeur.prenom" type="text" id="prenom" class="form-control form-control-lg" required />
                          <label class="form-label" for="prenom">Prénom</label>
                        </div>
                      </div>  
                      <div class="col-md-6 mb-4">
                        <div class="form-outline">
                          <input v-model="vendeur.nom" type="text" id="nom" class="form-control form-control-lg" required />
                    ...
                    <div class="form-outline mb-4">
                      <input v-model="vendeur.courriel" type="email" id="courriel" class="form-control form-control-lg" required />
                      <label class="form-label" for="courriel">Courriel</label>
                    </div>

                    <div class="form-outline mb-4">
                      <input v-model="vendeur.telephone" type="tel" id="telephone" class="form-control form-control-lg" required />
                      <label class="form-label" for="telephone">Téléphone</label>
                    </div>

                    <div class="form-outline mb-4">
                      <input v-model="vendeur.adresse.numeroCivique" type="text" id="numeroCivique" class="form-control form-control-lg" required />
                      <label class="form-label" for="numeroCivique">Numéro civique</label>
                    </div>

                    <div class="form-outline mb-4">
                      <input v-model="vendeur.adresse.rue" type="text" id="rue" class="form-control form-control-lg" required />
                    ...
                    <div class="row">
                      <div class="col-md-6 mb-4">
                        <div class="form-outline">
                          <input v-model="vendeur.adresse.ville" type="text" id="ville" class="form-control form-control-lg" required />
                          <label class="form-label" for="ville">Ville</label>
                        </div>
                      </div>
                      <div class="col-md-6 mb-4">
                        <div class="form-outline">
                          <select v-model="vendeur.adresse.province" id="province" class="form-select form-select-lg" required>
                    ...
                    <div class="form-outline mb-4">
                      <input v-model="vendeur.adresse.codePostal" type="text" id="codePostal" class="form-control form-control-lg" required />
                    ...
                    <div class="d-flex justify-content-end pt-3">
                      ...
                      <button type="submit" class="btn btn-custom btn-lg ms-2">Mettre à jour le vendeur</button>
                    </div>
                  </form>
                </div>
              </div>
...
onMounted(async () => {
  try {
    ...
    const normalizedLoadedProvince = normalizeString(vendeur.value.adresse.province);
    const matchedProvince = normalizedProvinces.value.find(p => p.normalized === normalizedLoadedProvince);
    if (matchedProvince) {
