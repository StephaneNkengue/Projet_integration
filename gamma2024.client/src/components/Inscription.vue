<template>
  <div class="background-container">
    <div
      class="container d-flex flex-column justify-content-start align-items-stretch vh-100 container col-md-6"
    >
          ...
          <Stepper v-model:activeIndex="activeIndex" :class="['mb-4']">
            ...
            <StepItem :disabled="activeIndex !== 1" class="information">
              ...
              <StepPanel v-if="activeIndex === 1" value="1">
                <div
                  class="d-flex px-4 py-2 flex-column justify-content-start align-items-stretch .i"
                >
                  ...
                  <div class="d-flex flex-row justify-content-between mb-3">
                    ...
                    <div class="form-group">
                      <label for="confirmMotPasse" class="ms-3"
            ...
            <StepItem :disabled="activeIndex !== 2" class="carte">
              ...
              <StepPanel v-if="activeIndex === 2" value="2">
                <div
                  class="d-flex flex-column justify-content-start align-items-stretch c"
                >
                  <div class="form-group flex-fill mb-3">
                    <label for="nomPropio" class="ms-3"
                  ...
                  <div class="d-flex flex-row justify-content-between mb-3">
                    <div class="form-group col-md-6">
                      <label for="numeroCarte" class="ms-3"
                    ...
                    <div class="form-group col-md-5">
                      <label for="dateExpiration" class="ms-3"
            ...
            <StepItem :disabled="activeIndex !== 3" class="adresse">
              ...
              <StepPanel v-if="activeIndex === 3">
                <div
                  class="d-flex flex-column justify-content-start align-items-stretch a"
                >
                  <div class="d-flex flex-row justify-content-between mb-3">
                    <div class="form-group">
                      <label for="numeroCivique" class="ms-3"
                  ...
                  <div class="d-flex flex-row justify-content-between mb-3">
                    <div class="form-group">
                      <label for="appartement" class="ms-3"
                        >Appartement/Bureau</label
                      >
                      <input
                        type="text"
                ...
                <div class="d-flex justify-content-between gap-2 py-3">
                  <button
                    class="btn btn-secondary rounded-pill px-5 ms-4"
                    @click="allerAuSuivantPrecedent(2)"
                  >
                    Précédent
                  </button>
